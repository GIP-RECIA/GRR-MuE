 ...
 * 
 * Interface d'accueil de Gestion des �tablissements de l'application GRR
...
/**
 * Compte le nombre d'�tablissement d�finis
 *
 ...
 */
 function count_etablissements()
 {
   ...
   if ($res)
   {
     ...
     if (is_array($etablissements))
       ...
       {
         echo '      <p>Une erreur est survenue pendant le comptage des �tablissements.</p>';
         // fin de l'affichage de la colonne de droite
         echo "</td></tr></table>\n</body>\n</html>\n";
         die();
       }
   } else {
     echo '      <p>Une erreur est survenue pendant la pr�paration de la requ�te de comptage des �tablissements.</p>';
     // fin de l'affichage de la colonne de droite
     echo "</td></tr></table>\n</body>\n</html>\n";
     die();
   }
 ...
 function create_etablissement($id)
 {
   ...
   // On affiche le formulaire de saisie quand l'appel de la fonction ne provient pas de la validation de ce m�me formulaire
   ...
   // Sinon, il faut valider le formulaire
     ...
     // On v�rifie que le code et le nom du site ont �t� renseign�s
 ...
 function read_etablissement()
 {
   ...
   if ($res)
   {
     ...
     echo '      <p>Une erreur est survenue pendant la pr�paration de la requ�te de lecture des �tablissements.</p>';
     // fin de l'affichage de la colonne de droite
     echo "</td></tr></table>\n</body>\n</html>\n";
     die();
     }
 ...
 function update_etablissement($id)
 {
   ...
   if (!isset($adresse)) $adresse = isset($_POST['adresse']) ? $_POST['adresse'] :  NULL;
     ...
     // On affiche le tableau des �tablissements
     read_etablissement();
   }
 ...
 {
   echo 'Vous voulez v�rifier les droits pour l\'identifiant '.$id;
 }
...
// Debut de l'affichage de la page
 ...
 //Varible globale permettant de savoir si l'utilisateur peut modifier les utilisateurs de l'�tablissement.
